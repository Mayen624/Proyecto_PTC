<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Hombre.aspx.cs" Inherits="Proyecto_PTC.Hombre" EnableEventValidation="false" %>
...
<body>
    ...
    <style type="text/css">
     ...
     <form id="Products_Hombre" runat="server">
